...
class ReponsableModel {
    // Defines a "resposável" is app.
    // Can even offer or search for rides.
    ...
    init(type: String, studentName: String, studentCPF: String,
         ...
         email: String, home: Location, institution: Location,
         isDriver: Bool, work: Location) {
    ...
    init(snapshot: DataSnapshot) {
        ...
        self.isDriver = snapshotValue["isDriver"] as! Bool
        // Fix locations
    ...
    //TODO: function to build Locations
